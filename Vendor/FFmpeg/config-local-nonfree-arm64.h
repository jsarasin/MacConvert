...
#define FFMPEG_CONFIGURATION "--prefix=/var/folders/x9/g1_fxl5x0rl9hkwxz3p32p8w0000gn/T//macconvert-ffmpeg-8.1.2-local-nonfree/install --target-os=darwin --arch=arm64 --cc=clang --enable-gpl --enable-version3 --enable-nonfree --disable-doc --disable-debug --disable-ffplay --disable-shared --enable-static --enable-ffmpeg --enable-ffprobe --enable-audiotoolbox --enable-openssl --enable-lcms2 --enable-fontconfig --enable-libfreetype --enable-libfribidi --enable-libharfbuzz --enable-libaom --enable-libaribcaption --enable-libass --enable-libbluray --enable-libbs2b --enable-libcodec2 --enable-libdav1d --enable-libfdk-aac --enable-libgme --enable-libgsm --enable-libilbc --enable-libjxl --enable-liblc3 --enable-libmodplug --enable-libmp3lame --enable-liboapv --enable-libopenh264 --enable-libopenjpeg --enable-libopenmpt --enable-libopus --enable-librav1e --enable-librist --enable-librubberband --enable-libsnappy --enable-libsoxr --enable-libspeex --enable-libsrt --enable-libssh --enable-libsvtav1 --enable-libtheora --enable-libtwolame --enable-libvidstab --enable-libvmaf --enable-libvorbis --enable-libvpx --enable-libvvenc --enable-libwebp --enable-libx264 --enable-libx265 --enable-libxvid --enable-libzimg --enable-libzmq --enable-chromaprint --extra-cflags='-arch arm64 -mmacosx-version-min=14.0 -I/opt/homebrew/include' --extra-ldflags='-arch arm64 -mmacosx-version-min=14.0 -L/opt/homebrew/lib'"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2026
#define FFMPEG_DATADIR "/var/folders/x9/g1_fxl5x0rl9hkwxz3p32p8w0000gn/T//macconvert-ffmpeg-8.1.2-local-nonfree/install/share/ffmpeg"
#define AVCONV_DATADIR "/var/folders/x9/g1_fxl5x0rl9hkwxz3p32p8w0000gn/T//macconvert-ffmpeg-8.1.2-local-nonfree/install/share/ffmpeg"
...
#define CONFIG_LIBARIBCAPTION 1
